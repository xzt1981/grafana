    ...
    <ul class="dropdown-menu dropdown-menu--menu panel-menu" role="menu">
      ...
      <li class="dropdown-submenu">
        ...
        <ul class="dropdown-menu panel-menu">
          ...
          <li><a ng-click="ctrl.addDataQuery(datasource);"><i class="fa fa-bullseye"></i> 图例开关</a></li>
          <li><a ng-click="ctrl.addDataQuery(datasource);"><i class="fa fa-download"></i> 导出到 CSV</a></li>
          <li><a ng-click="ctrl.addDataQuery(datasource);"><i class="fa fa-eye"></i> JSON视图</a></li>
        </ul>
      </li>
