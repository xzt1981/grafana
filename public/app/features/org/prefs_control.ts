...
export class PrefsControlCtrl {
  ...
  themes: any = [{ value: '', text: '默认' }, { value: 'dark', text: '深色' }, { value: 'light', text: '浅色' }];
...
<form name="ctrl.prefsForm" class="section gf-form-group">
  <h3 class="page-heading">个性化设置</h3>

  <div class="gf-form">
    <span class="gf-form-label width-11">界面主题</span>
  ...
  <div class="gf-form">
    <span class="gf-form-label width-11">
      ...
      <info-popover mode="right-normal">
        没有找到您要的仪表盘? 先标记它，标记过的将会展示在这个选择框中。
      </info-popover>
    </span>
